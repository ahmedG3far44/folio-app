...
function Hero({
  ...
  return (
    <>
      {isLogged && <ChagneLayoutForm sectionName="heroLayout" />}
      <ApplyLayout
        type="parent"
        sectionName="heroLayout"

        // className="lg:w-3/4 w-full p-4 m-auto flex flex-col justify-start lg:justify-center items-center gap-8 mb-16 lg:gap-16"
      >
        <div className="flex flex-col justify-center items-center gap-8">
          ...
          <Card
            ...
            className="w-full max-w-3/4 mx-auto p-4"
          >
            <p>{bioInfo?.bio}</p>
          </Card>
        </div>
